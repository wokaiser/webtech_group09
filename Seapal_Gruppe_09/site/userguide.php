  	...
  	<body>
		...
		<div class="container-fluid">
			...
			<div class="span8">
                ...
                <div>
                    ...
                    <div id="start">
                        ...
                        <figure>
                                <img src="http://seapal.info/images/SeaPal-InitialPosition.jpg" alt="SeaPal-InitialPosition" width="580" height="435"/>
                    ...
                    <div id="select">
                        ...
                        <div>
                            ...
                            <figure>
                                <img src="http://seapal.info/images/SeaPal-Gothenborg-Menu.jpg" alt="SeaPal-Gothenborg-Menu" width="580" height="435"/>
                            ...
                            <figure>
                                <img src="http://seapal.info/images/SeaPal-SatelliteView.jpg" alt="SeaPal-SatelliteView" width="580" height="435"/>
                            ...
                            <figure>
                                <img src="http://seapal.info/images/SeaPal-Southampton-OSM.jpg" alt="SeaPal-Southampton-OSM" width="580" height="435"/>
                            ...
                            <figure>
                                <img src="http://seapal.info/images/SeaPal-Konstanz-IBN.jpg" alt="SeaPal-Konstanz-IBN" width="580" height="435"/>
            ...
            <div class="span4"><!-- Navigation -->
                ...
                <li class="divider"></li>
                <li class="active"><a href="#install">Installing SeaPal</a></li>
                <li><a href="#start">Starting SeaPal</a></li>
                <li><a href="#select">Map Selection</a></li>
                <li><a href="../img/screenshots/SeaPal-Legend-IBN-Map.pdf">Legend of IBN</a></li>
                </ul>
            </div>                
		</div><!-- Container -->
